...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste animi optio amet beatae quo exercitationem ea magni aspernatur blanditiis, iusto omnis fugit mollitia, nisi et maxime. Quia vitae amet quisquam!</p>
    </div>
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Bikes</a></li>
        </ul>
      </div>
